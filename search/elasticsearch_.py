...
class ElasticSearch(Search):
    ...
    def get_contacts_by_id (self, contact_id_list):
        ...
        #         "must": [
        #             {"terms": {
        #                 "contact_id": [9628, 28053, 28054, 28055, 28043, 28047, 28071, 28099, 28073, 28119, 28098,
        #                                28123, 28124, 28105, 28106]}}
        #         ]
        #     }
        # },
        # "_source": true
        ...
        elastic_query_data = {
            ...
            "query": {
                "bool": {
                    ...
                    "must_not": [{
                        "term": {"contact_id": self.contact_id}
                    }],
                    #"filter": [{"term": {"contact_id": 28042}}]
                    #"filter": [{"term": {"first_name": "ivan"}}]
    ...
    def tag_filter (self, result_item, filter_name):
        ...
        if filter_name:
            ...
            if filter_name in tag_lookup:
                ...
                # else:
                #
                #     print("Result with not csv_tags ", json.dumps(result_item, sort_keys=True, indent=4))
                        ...
                        for first_degree_connection in first_degree_connections:
                            ...
                            for second_degree_connection in check_second_degree_connections:
                                ...
                                if int(contact_degree_ids) == result_item['contact_id']:
                                    ...
                                    break
                                # else:
                                # print("Contact Degree ID not found \n....")
                                # print(contact_degree_ids)
                                # print("Result ID \n......")
                                # print(result_item['contact_id'])

                            # if second_degree_not_found

                            # if not second_degree_found:
